...
// ── Bangalore city boundary (extended to include Sarjapur, Jigani, Attibele, Anekal) ─
const CITY_BOUNDARY: [number, number][] = [
  ...
  // East – push out to cover Sarjapur & Attibele
  [12.980,77.780],[12.960,77.800],[12.935,77.820],
  [12.908,77.838],[12.878,77.840],[12.848,77.832],
  [12.820,77.820],[12.795,77.800],[12.775,77.772],
  // Southeast – Attibele at ~12.782°N 77.801°E
  [12.758,77.740],[12.742,77.705],[12.728,77.668],
  // South – Anekal at ~12.710°N 77.697°E
  [12.700,77.650],[12.692,77.605],[12.695,77.558],
  [12.705,77.515],[12.720,77.478],
  // Southwest
  [12.748,77.448],[12.780,77.425],[12.815,77.408],
  // West
  [12.855,77.400],[12.895,77.395],[12.930,77.398],
  [12.960,77.408],[12.988,77.422],[13.015,77.440],
  [13.040,77.460],[13.060,77.480],
  // Northwest back to start
  [13.078,77.500],[13.095,77.520],[13.110,77.535],
  [13.130,77.540],
];
