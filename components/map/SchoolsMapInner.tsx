...
// ── Bangalore city boundary (extended to include Sarjapur, Jigani, Attibele) ─
const CITY_BOUNDARY: [number, number][] = [
  ...
  // East side extending further SE to cover Sarjapur & Attibele
  [12.980,77.780],[12.960,77.796],[12.935,77.810],
  [12.908,77.822],[12.878,77.822],[12.848,77.812],
  [12.820,77.792],[12.795,77.765],[12.778,77.732],
  // South – dipping to cover Attibele (~12.765°N)
  [12.765,77.695],[12.758,77.655],[12.760,77.612],
  [12.768,77.572],[12.782,77.535],
  // Southwest
  [12.802,77.502],[12.830,77.474],[12.862,77.456],
  // West
  [12.898,77.448],[12.928,77.445],[12.958,77.450],
  [12.985,77.455],[13.010,77.465],[13.035,77.478],
  // Northwest back to start
  [13.058,77.493],[13.078,77.510],[13.095,77.528],
  [13.110,77.537],[13.130,77.540],
];
